...
function generatePassword () {
  ...
  function askForPwdLen () {
    var promptPwdLen = prompt("Please select a password length between 8 and 128?")

    while (promptPwdLen  < 8 || promptPwdLen  > 128){
      alert("Invalid password length Entered!");
      promptPwdLen  = prompt("Please enter a valid password length not less than 8 and not greater than 128");
    }
    return promptPwdLen ;
  }
